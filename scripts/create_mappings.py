...
def main():
    ...
    tables = [
            ("rel_artist_recording_group", "Artist", "RecordingGroup", "musicbrainz.artist.id", "artist_id", "recording_group", "recording_group.recording_group"),
            ...
            ("rel_recording_group_recording_group", "RecordingGroup", "RecordingGroup", "recording_group.recording_group", "recording_group", "recording_group2", "recording_group.recording_group"),
            ...
            ("rel_area_recording_group", "Area", "RecordingGroup", "musicbrainz.area.id", "area_id", "recording_group", "recording_group.recording_group"),
